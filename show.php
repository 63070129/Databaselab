...
?>
  <tr>
    ...
    <td><div align="center"><?php echo'<a href="delete.php?delete_id='.$Result['ID'].'" class="btn btn-primary">ลบ</a>'?>  <a href="edit.php?id=<?php echo $data['id']; ?>" class="btn btn-primary">แก้ไข</a></td>
  </tr>
  <?php
}
?>
