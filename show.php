...
?>
  <tr>
    ...
    <td><div align="center"><a href="delete.php/id=<?php $_POST['ID'];?><?php echo $data['id']; ?>" class="btn btn-primary">ลบ</a>   <a href="edit.php?id=<?php echo $data['id']; ?>" class="btn btn-primary">แก้ไข</a></td>
  </tr>
<?php
}
?>
